...
export const REGISTER_SEED = {
  risk: [
    { riskId: 'RISK-001', description: 'Exposure of customer conversation data through a misconfigured storage bucket', likelihood: 3, impact: 5, treatment: 'Modify', relatedControls: 'A.5.23, A.8.9, A.8.12', owner: 'Information Security Lead', status: 'Open', reviewDate: '2026-09-30' },
    { riskId: 'RISK-002', description: 'Account takeover of the administration console through credential stuffing', likelihood: 3, impact: 4, treatment: 'Modify', relatedControls: 'A.5.15, A.5.17, A.8.5', owner: 'Head of Engineering', status: 'Treated', reviewDate: '2026-09-30' },
    { riskId: 'RISK-003', description: 'Prolonged service outage caused by a single hosting region dependency', likelihood: 2, impact: 4, treatment: 'Modify', relatedControls: 'A.5.29, A.5.30, A.8.14', owner: 'Head of Platform', status: 'Open', reviewDate: '2026-10-31' },
    { riskId: 'RISK-004', description: 'Personal data processed outside the UK or EU by a sub-processor', likelihood: 2, impact: 5, treatment: 'Avoid', relatedControls: 'A.5.19, A.5.20, A.5.34', owner: 'Data Protection Officer', status: 'Open', reviewDate: '2026-08-31' },
    { riskId: 'RISK-005', description: 'Prompt injection causing the assistant to disclose sensitive information', likelihood: 3, impact: 4, treatment: 'Modify', relatedControls: 'A.8.26, A.8.28', owner: 'AI Governance Lead', status: 'Open', reviewDate: '2026-09-15' },
    { riskId: 'RISK-006', description: 'Failure or withdrawal of the primary model provider', likelihood: 2, impact: 4, treatment: 'Share', relatedControls: 'A.5.19, A.5.21, A.5.22', owner: 'Procurement Lead', status: 'Open', reviewDate: '2026-11-30' },
    { riskId: 'RISK-007', description: 'Insider misuse of production access to customer data', likelihood: 2, impact: 4, treatment: 'Modify', relatedControls: 'A.5.18, A.8.2, A.8.15', owner: 'Information Security Lead', status: 'Treated', reviewDate: '2026-10-31' },
    { riskId: 'RISK-008', description: 'Ransomware affecting corporate endpoints and shared drives', likelihood: 2, impact: 4, treatment: 'Modify', relatedControls: 'A.8.7, A.8.13, A.6.3', owner: 'IT Manager', status: 'Open', reviewDate: '2026-09-30' },
  ],
  asset: [
