...
export { AIRPORTS } from './airports.js?v=10';
...
export { STATIONS } from './stations.js?v=10';
...
export { BUS_STATIONS } from './busstations.js?v=10';
...
export { EU_STATIONS } from './eustations.js?v=10';
