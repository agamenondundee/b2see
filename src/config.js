...
export { AIRPORTS } from './airports.js?v=9';
...
export { STATIONS } from './stations.js?v=9';
...
export { BUS_STATIONS } from './busstations.js?v=9';
...
export { EU_STATIONS } from './eustations.js?v=9';
